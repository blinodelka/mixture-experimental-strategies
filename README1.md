...
- Create a new repository on GitHub (a sensible name for the repository would be autora-theorist-example)
...
You may now add your code to `src/autora/theorist/example/__init__.py` file. You may 
...
It is highly encouraged to add unit tests to ensure your code is working as intended. These can be [doctests](https://docs.python.org/3/library/doctest.html) or test cases in `tests/test_example.py`.
